	...
	do {
	  ...
	  switch (Ch) {
		...
		if(DelElemPos(queuePath, CurElem))
		{
	      ...
	      break;
	    case K_CR:
	      if(SendFilePos(queuePath, CurElem)) DelElemPos(queuePath, CurElem);
	      ClrWin(2, 5, 78, 24);
	      if((max = RefreshList(queuePath)) != 0)
	      {
		InElem = CurElem = 0;
	  ...
	  {
	    if(SendFilePos(queuePath, 0)) DelElemPos(queuePath, CurElem);
	    ClrWin(2, 5, 78, 24);
	    if((max = RefreshList(queuePath)) != 0)
	    {
	      InElem = CurElem = 0;
...
int SendFilePos(const char *queuePath, int Pos)
{
  ...
  if(GetElem(Pos, &Elem))
  {
    ...
    if((rst = !spawnl(P_WAIT, "U:\\ZIP\\PKZIP\\PKUNZIP", "", "-PB", fullFileName, NULL)) == 0)
    {
...
void InitScr(void)
{
  ...
  cprintf("บ               G E R E N C I A D O R   D E   I M P R E S S A O               บ\r\n");
  cprintf("ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ\r\n");
  NormScr();
  cprintf("ษอ NUM อ USUARIO ออ ARQUIVO ออออออออออออออออออออออออออออออออออ DATA อออ HORA อป\r\n");
  for(i = 0; i < MAXLN; i++)
    cprintf("บ                                                                             บ\r\n");
  cprintf("ศอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ");
  gotoxy(3, 25);
