...
struct resbuf* rbnewitem(rbufdesc_t* desclist, int restype, TCHAR* resval);
...
struct resbufdb* rbnewitem(rbufdbdesc_t* desclist, int restype, TCHAR* resval);
...
// fstitem - ponteiro para o item da lista
