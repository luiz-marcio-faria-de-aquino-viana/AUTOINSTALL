...
static char* err_msgtbl[] = {
// manipulacao do arquivo de configuracao
	/* #000 */	"Nao foi possivel encontrar o arquivo de configuracao.",
				"Nao foi possivel abrir o arquivo de configuracao.",
				"Nao foi possivel ler o arquivo de configuracao.",
				"Entrada invalida no arquivo de configuracao.",
// manipulacao de arquivo em geral
	/* #004 */	"Nao foi possivel encontrar o arquivo.",
				"Nao foi possivel abrir o arquivo.",
// manipulacao de modulos do programa
	/* #006 */	"Tentativa de carregar um modulo invalido.",
				"Falha na inicializacao dos modulos.",
// manipulacao dos argumentos passados a aplicacao
	/* #008 */	"Numero de argumentos invalido.",
				"Tipo de argumento invalido.",
				"Tipo de argumento requerido invalido.",
// manipulacao de recursos de rede
    /* #011 */  "Nao foi possivel obter o nome do usuario.",
				"Nao foi possivel obter o nome do computador."
// manipulacao de memoria
	/* #013 */	"Nao foi possivel alocar memoria."
};
